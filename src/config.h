...
#define APP_VERSION "v5.0.7"
#define APP_RELEASE_DATE "2026-07-12"
...
#define GPS_MODULE_TYPE_GPS_V21_GNSS 3
...
// Mobile relay BLE service for iOS/Android app
#define EVDASH_RELAY_SERVICE_UUID "17600000-1760-4d5e-8000-657664617368"
#define EVDASH_RELAY_NOTIFY_UUID "17600001-1760-4d5e-8000-657664617368"
#define EVDASH_RELAY_WRITE_UUID "17600002-1760-4d5e-8000-657664617368"
...
typedef enum
{
  ...
  VEHICLE_TYPE_SKODA_CITIGO_E_IV,
  ...
  MENU_ADAPTER_MOBILE_RELAY,
  MENU_ADAPTER_MOBILE_RELAY_PAIR,
  MENU_ADAPTER_MOBILE_RELAY_FORGET,
  ...
  MENU_REMOTE_UPLOAD_TRACCAR_ENABLED,
  MENU_REMOTE_UPLOAD_TRACCAR_SERVER,
  MENU_REMOTE_UPLOAD_TRACCAR_PORT,
